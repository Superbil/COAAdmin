  ...
  <head>
    ...
    <script>
     ...
     function query() {
       ...
       var sparqlb3 = "FILTER regex (?S2,'" +filter+ "')FILTER ( ?Product_label = ?S )FILTER ( ?ProductX = ?S3 )}"
       var sparqlb2 = "FILTER regex (?Operation_label,'" +filter+ "')}"
       ...
       //  alert(sparql+sparqlb);
       //   alert(sparqlb2+sparql2);

       //    alert(sparqlb3+sparql3);
...
PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>
            ...
            ?ProductX tgap:processLocation ?OperationX  .
...
PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>
            ...
            SELECT distinct (coalesce(?Product_label,?class) as ?S) (coalesce(?Operation_label,?class) as ?S2) (coalesce(?ProductX,?class) as ?S3)   WHERE {
            ?ProductX tgap:processLocation ?Operation  .
